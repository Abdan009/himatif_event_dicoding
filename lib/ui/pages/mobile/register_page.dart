        ...
        Container(
          ...
          child: ListView(
            children: [
              ...
              FieldInputCustom(namaController, 'Nama Lengkap'),
              SizedBox(
                height: 10,
              ),
              ComboboxWidget(
              ...
              FieldInputCustom(emailController, 'Email'),
              SizedBox(
                height: 10,
              ),
              FieldInputCustom(
              ...
              FieldInputCustom(angkatanController, 'Tahun Angkatan'),
              SizedBox(
                height: 10,
              ),
              SizedBox(
                ...
                Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          navigatorPage(context, navigator: NavigatorPage.pop);
                        },
                        child: Text(
                          'Masuk',
