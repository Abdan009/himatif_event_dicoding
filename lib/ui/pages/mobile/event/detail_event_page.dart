...
class DetailEventAdminPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<EventCubit, EventState>(builder: (_, eventState) {
      ...
      double heightLayout = MediaQuery.of(context).size.height;
      return Scaffold(
        appBar: appBar(
          event?.name ?? '',
          actions: [
                          ...
                          Container(
                            ...
                            child: Center(
                              child: Text(
                                event.category,
                                style:
                                    blackTextFont.copyWith(color: Colors.white),
                              ),
                            ),
                          ),
                          Container(
                            height: 50,
                            width: widthLayout - (2 * defaultMargin),
                            child: Text(
                              event.name,
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(body, style: blackTextFont),
          )
        ],
      ),
    );
          ...
          Container(
            child: Column(
              ...
              children: [
                ...
                Container(
                    margin: EdgeInsets.only(top: 5),
                    child: Text(event.organizer, style: blackTextFont)),
              ],
            ),
          ),
          Container(
        ...
        children: [
          ...
          Container(
            child: Row(
              ...
              children: [
                Container(
                  width: widthLayout * 0.5 - defaultMargin,
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
